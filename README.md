...
1.Add q query param `?superSearch=` to the `/tickets` API call and implement an _efficient_ search solution, that gets a word as an input and return an array of matching tickets. 2. Connect your client side search bar to that API call
